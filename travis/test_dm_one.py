...
test_case = {
  'name' : 'Test DM - One Match',
  'description' : 'The /dm command works correctly when one user has the nickname.',
  'points_possible' : 10,
  'points_earned' : 0,
  'test_ran' : False,
  'test_passed' : False,
...
def do_test( test_case, skip_remaining_tests ):
  ...
  if ( server.poll() != None or ( not all_clients_running ) ):
    ...
    print('Checking output to ensure only client 1 received the /dm...')
